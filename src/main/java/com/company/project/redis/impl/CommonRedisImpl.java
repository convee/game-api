package com.company.project.redis.impl;

import com.company.project.redis.CommonRedis;
...
public class CommonRedisImpl implements CommonRedis {
    ...
    private static final String KEY_PREFIX_SET = "set:";
    private static final String KEY_PREFIX_LIST = "list:";
    ...
    @Autowired
    public CommonRedisImpl(RedisTemplate<String, String> redisTemplate) {
